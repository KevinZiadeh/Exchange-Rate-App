...
class Transaction(db.Model):
 def __init__(self, usd_amount, lbp_amount, usd_to_lbp, user_name,receiver_name):
...
class TransactionSchema(ma.Schema):
 class Meta:
  fields = ("id", "usd_amount", "lbp_amount", "usd_to_lbp","user_name","added_date","receiver_name")
  model = Transaction
